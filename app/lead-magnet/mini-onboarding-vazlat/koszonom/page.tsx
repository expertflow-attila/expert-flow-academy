        ...
        <section className="border-b border-border py-24 md:py-32">
          <div className="mx-auto max-w-2xl px-6 lg:px-10">
            ...
            <p className="mt-6 font-sans text-base leading-relaxed text-foreground-soft">
              A „Szakmai-leíró 30 nap&rdquo; kurzus 5. modulja arról szól, hogyan adsz át egy folyamatot úgy, hogy a 2-3 fős csapatban senki ne legyen elveszve. 49 000 Ft, 27 lecke. Akkor jöjjön szóba, ha érzitek, hogy a vázlaton túl a rendszer is hiányzik.
            </p>
            <div className="mt-10">
              <a
